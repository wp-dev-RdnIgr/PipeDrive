var FIELDS = [
  ...
  {key:'add_time',field_id:12465,label:'Дата створення',type:'date',operators:['>=','<=']},
  {key:'update_time',field_id:12466,label:'Дата оновлення',type:'date',operators:['>=','<=']},
  {key:'won_time',field_id:12470,label:'Дата виграшу',type:'date',operators:['>=','<=']},
  {key:'lost_time',field_id:12473,label:'Дата програшу',type:'date',operators:['>=','<=']},
  {key:'close_time',field_id:12474,label:'Дата закриття',type:'date',operators:['>=','<=']},
  {key:'expected_close_date',field_id:12484,label:'Очікувана дата закриття',type:'date',operators:['>=','<=']},
  {key:'value',field_id:12456,label:'Вартість',type:'monetary',operators:['=','!=','>','<','>=','<=']},
  ...
  {key:'probability',field_id:12458,label:'Імовірність',type:'int',operators:['=','>','<','>=','<=']},
  {key:'origin',field_id:12519,label:'Джерело походження',type:'enum',operators:['=','!='],options:[{id:'ManuallyCreated',label:'Створений вручну'},{id:'Import',label:'Імпорт'},{id:'API',label:'API'},{id:'Automation',label:'Автоматизація'},{id:'WebForms',label:'Вебформи'},{id:'Chatbot',label:'Чат-бот'},{id:'LiveChat',label:'Онлайн-чат'},{id:'Campaigns',label:'Campaigns'}]},
  {key:'channel',field_id:12521,label:'Канал походження',type:'enum',operators:['=','!='],options:[{id:100,label:'Web forms'},{id:101,label:'Chatbot'},{id:102,label:'Live chat'},{id:104,label:'Campaigns'},{id:106,label:'Messaging Inbox'}]},
  // Custom fields
  ...
  {key:'c0a6991f8b97eb6fad1d19dbf26ca32b8ff78760',field_id:12504,label:'Позиція клієнта',type:'enum',operators:['=','!='],options:[{id:50,label:'Маркетолог'},{id:51,label:'Власник'}]},
  ...
  {key:'edd70f6d7138760fca5573f6f84868303eb6b38c',field_id:12515,label:'Оброблено',type:'enum',operators:['=','!='],options:[{id:92,label:'Вчасно'},{id:93,label:'З запізненням'},{id:94,label:'Очікує'}]},
  {key:'b89035f86a699ca59229900f42ab9f627017b871',field_id:12498,label:'Перенесена з холодної',type:'enum',operators:['=','!='],options:[{id:41,label:'Так'},{id:42,label:'Ні'}]},
  ...
  {key:'2f11d1175b4233f85c7e528d4422d2552f9feda8',field_id:12512,label:'Дата призначення якості ліда',type:'date',operators:['>=','<=']},
...
var PRESET_REPORTS = [
  {
    ...
    columns:[
      ...
      {key:'c_utm_medium',label:'Utm Medium',width:130,truncate:true},
      {key:'owner_name',label:'Менеджер',width:140,truncate:true},
      {key:'c_lead_quality',label:'Якість ліда',lookup:12497,width:100},
      {key:'stage_name',label:'Етап',width:150,truncate:true},
      {key:'value',label:'Сума угоди',money:true,width:110},
      {key:'c_kp_specialist',label:'Спеціаліст КП',width:140,truncate:true},
      {key:'c_kp_link',label:'Лінк на КП',external_link:true,width:100},
      ...
      {key:'c_site_page',label:'Сторінка сайту',external_link:true,width:120},
      {key:'lost_reason',label:'Причина програшу',width:150,truncate:true},
      {key:'c_loss_comment',label:'Коментар програшу',width:180,expandable:true}
    ],
    description:'Воронка КП, причини програшу, конверсія менеджерів'
  },
  {
